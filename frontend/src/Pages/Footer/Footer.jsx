...
const ColorFoot = () => (
  <footer className="bg-gradient-to-r from-blue-100 via-blue-500 to-blue-600  ps-20 md:p-10 font-[sans-serif] tracking-wide">
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mt-1">
    <div className="lg:col-span-2">
      ...
      <ul className="flex space-x-6 my-2">
        <li>
          <a
            href="#"
            aria-label="Facebook"
            className="text-white text-2xl hover:text-[#82E9FF]">
            <SiFacebook />
          </a>
        </li>
        <li>
      ...
      <address className="font-bold text-white text-sm space-y-1">
        <span className="text-[#FFCDD2] font-bold text-2xl">
          Universe Visuals
        </span>
        <br />
    ...
    <div>
      <h4 className="text-lg font-semibold mb-6 text-[#FFCDD2]">
        Product List
      </h4>
      <ul className="space-y-4">
        <li>
          <Link
            to="/OurProducts"
            className="text-white hover:text-[#82E9FF] text-sm">
            Digital Podium
          </Link>
        </li>
        <li>
    ...
    <div>
      ...
      <ul className="space-y-4">
        <li>
          <Link to="/" className="text-white hover:text-[#82E9FF] text-sm">
            Home
          </Link>
        </li>
        <li>
        ...
        <li>
          <Link to="/About" className="text-white hover:text-[#82E9FF] text-sm">
            About Us
          </Link>
        </li>
        <li>
